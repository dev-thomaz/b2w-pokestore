...
const Header: React.FC<HeaderProps> = (props) => {
  ...
  useEffect(() => {
    window.location.pathname.split('/')[1] === 'cart' || window.location.pathname.split('/')[1] === 'favorites' || window.location.pathname.split('/')[1] === 'orders' || window.location.pathname.split('/')[1].length < 1  ? setShowSearch(false) : setShowSearch(true)
